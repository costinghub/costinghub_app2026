            ...
            <thead className="bg-background/50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Tool Name <button onClick={(e) => setActivePopover({ column: 'name', anchorEl: e.currentTarget })}><FilterIcon isActive={!!filters.name} /></button></div>
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Type <button onClick={(e) => setActivePopover({ column: 'toolType', anchorEl: e.currentTarget })}><FilterIcon isActive={!!filters.toolType?.length} /></button></div>
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Material <button onClick={(e) => setActivePopover({ column: 'material', anchorEl: e.currentTarget })}><FilterIcon isActive={!!filters.material?.length} /></button></div>
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Diameter (mm) <button onClick={(e) => setActivePopover({ column: 'diameter', anchorEl: e.currentTarget })}><FilterIcon isActive={filters.minDiameter !== undefined || filters.maxDiameter !== undefined} /></button></div>
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Est. Life (hrs) <button onClick={(e) => setActivePopover({ column: 'estimatedLife', anchorEl: e.currentTarget })}><FilterIcon isActive={filters.minEstimatedLife !== undefined || filters.maxEstimatedLife !== undefined} /></button></div>
                </th>
...
const CategoricalFilter: React.FC<{column: string; filters: Record<string, any>; onApplyFilter: (col: string, val: any) => void; onClearFilter: (col: string) => void;}> = ({ column, filters, onApplyFilter, onClearFilter }) => {
...
const RangeFilter: React.FC<{column: string; filters: Record<string, any>; onApplyFilter: (col: string, val: any) => void; onClearFilter: (col: string) => void;}> = ({ column, filters, onApplyFilter, onClearFilter }) => {
...
const TextFilter: React.FC<{column: string; filters: Record<string, any>; onApplyFilter: (col: string, val: any) => void; onClearFilter: (col: string) => void;}> = ({ column, filters, onApplyFilter, onClearFilter }) => {
...
const FilterContent: React.FC<{column: string; filters: Record<string, any>; onApplyFilter: (col: string, val: any) => void; onClearFilter: (col: string) => void;}> = ({ column, filters, onApplyFilter, onClearFilter }) => {
    if (column === 'toolType' || column === 'material') {
        return <CategoricalFilter column={column} filters={filters} onApplyFilter={onApplyFilter} onClearFilter={onClearFilter} />;
    }
    
    if (['diameter', 'estimatedLife'].includes(column)) {
        return <RangeFilter column={column} filters={filters} onApplyFilter={onApplyFilter} onClearFilter={onClearFilter} />;
    }
    
    return <TextFilter column={column} filters={filters} onApplyFilter={onApplyFilter} onClearFilter={onClearFilter} />;
};