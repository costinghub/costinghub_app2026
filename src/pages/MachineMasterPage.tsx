            ...
            <thead className="bg-background/50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Machine Name <button onClick={(e) => setActivePopover({ column: 'name', anchorEl: e.currentTarget })}><FilterIcon isActive={!!filters.name} /></button></div>
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Type <button onClick={(e) => setActivePopover({ column: 'machineType', anchorEl: e.currentTarget })}><FilterIcon isActive={!!filters.machineType?.length} /></button></div>
                </th>
                ...
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Power (kW) <button onClick={(e) => setActivePopover({ column: 'powerKw', anchorEl: e.currentTarget })}><FilterIcon isActive={filters.minPowerKw !== undefined || filters.maxPowerKw !== undefined} /></button></div>
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">
                    <div className="flex items-center gap-2">Add. Axis <button onClick={(e) => setActivePopover({ column: 'additionalAxis', anchorEl: e.currentTarget })}><FilterIcon isActive={!!filters.additionalAxis?.length} /></button></div>
                </th>
