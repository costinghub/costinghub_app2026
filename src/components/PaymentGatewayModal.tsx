...
interface PaymentGatewayModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectGateway: (gateway: 'instamojo') => void;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4 animate-fade-in">
      <Card className="max-w-md w-full relative text-center">
        ...
        <div className="grid grid-cols-1 gap-4">
          <Button onClick={() => onSelectGateway('instamojo')} className="flex items-center justify-center py-4 bg-primary hover:bg-primary/90 border-none shadow-lg text-black font-bold">
             Pay with Instamojo
          </Button>
        </div>
